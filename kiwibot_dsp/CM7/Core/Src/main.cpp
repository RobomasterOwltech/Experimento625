...
float Ax, Ay, Az;
float filterCoefficients[] = {0.0082,	0.0328,	0.0747,	0.1252,	0.1673,	0.1836,	0.1673,	0.1252,	0.0747,	0.0328,	0.0082};
float filterState[sizeof(filterCoefficients) - 1];
/* USER CODE END PV */
...
/* USER CODE BEGIN Header_StartJoystick */
/**
